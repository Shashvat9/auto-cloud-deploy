...
def main():
    """
    Reads XML from stdin, parses it, and prints the resulting JSON to stdout.
    """

    if len(sys.argv) > 1:
        instruction_json = parse_drawio_xml_v3(sys.argv[1])
    else:
        instruction_json = parse_drawio_xml_v3(sys.stdin)
